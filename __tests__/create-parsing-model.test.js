...
const create_parsing_model_1 = __importDefault(require("../src/create-parsing-model"));
describe("createParsingModel", () => {
    ...
    it("cria um modelo de parsing simples com extractor", () => {
        ...
        const instance = (0, create_parsing_model_1.default)({
    ...
    it("lança erro para tipo de modelo não permitido", () => {
        ...
        expect(() => (0, create_parsing_model_1.default)({
            config: { allowedExtractors, allowedModels },
            model
